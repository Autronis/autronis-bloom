...
const Index = () => {
  ...
  return (
    <Layout>
      {/* Hero */}
      <section className="relative min-h-[80vh] sm:min-h-screen flex flex-col items-center justify-center overflow-hidden" style={{ backgroundColor: "color-mix(in hsl, hsl(var(--background)), hsl(var(--foreground)) 8%)" }}>
        <HeroBackground />
