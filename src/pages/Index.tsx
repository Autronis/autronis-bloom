    ...
    <Layout>
      ...
      <section className="relative min-h-[80vh] sm:min-h-screen flex flex-col overflow-hidden">
        <div className="container mx-auto px-4 lg:px-8 relative z-10 flex-1 flex flex-col justify-center pb-16 sm:pb-28">
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6 lg:gap-16 w-full">
            ...
            {/* Team photo - visible on all sizes, smaller on mobile */}
            <div className="flex justify-center w-full lg:w-auto lg:flex-shrink-0 lg:self-center mt-2 lg:mt-0">
              <div className="relative w-40 h-52 sm:w-52 sm:h-64 lg:w-64 lg:h-80 xl:w-72 xl:h-[24rem] rounded-2xl overflow-hidden">
