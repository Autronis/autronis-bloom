...
export const categoryMeta: Record<SkillCategory, {
  ...
  automation: {
    border: "border-[hsl(215_55%_50%/0.35)]",
    bg: "bg-[hsl(215_55%_50%/0.12)] dark:bg-[hsl(215_55%_50%/0.08)]",
    text: "text-[hsl(215_55%_35%)] dark:text-[hsl(215_55%_70%)]",
    glow: "hover:border-[hsl(215_55%_50%/0.55)] hover:shadow-[0_0_10px_hsl(215_55%_50%/0.12)]",
    overlayBorder: "border-[hsla(215,45%,50%,0.55)]",
    overlayBg: "bg-[hsla(215,40%,25%,0.92)]",
  },
  ai: {
    ...
    overlayBorder: "border-[hsla(150,45%,42%,0.55)]",
    overlayBg: "bg-[hsla(150,35%,22%,0.92)]",
  },
  data: {
    border: "border-[hsl(30_65%_50%/0.35)]",
    bg: "bg-[hsl(30_65%_50%/0.12)] dark:bg-[hsl(30_65%_50%/0.08)]",
    text: "text-[hsl(30_65%_35%)] dark:text-[hsl(30_65%_70%)]",
    glow: "hover:border-[hsl(30_65%_50%/0.55)] hover:shadow-[0_0_10px_hsl(30_65%_50%/0.12)]",
    overlayBorder: "border-[hsla(30,50%,45%,0.55)]",
    overlayBg: "bg-[hsla(30,40%,22%,0.92)]",
  },
  operations: {
    border: "border-[hsl(270_45%_55%/0.35)]",
    bg: "bg-[hsl(270_45%_55%/0.12)] dark:bg-[hsl(270_45%_55%/0.08)]",
    text: "text-[hsl(270_45%_40%)] dark:text-[hsl(270_45%_72%)]",
    glow: "hover:border-[hsl(270_45%_55%/0.55)] hover:shadow-[0_0_10px_hsl(270_45%_55%/0.12)]",
    overlayBorder: "border-[hsla(270,35%,50%,0.55)]",
    overlayBg: "bg-[hsla(270,30%,25%,0.90)]",
  },
  infrastructure: {
    border: "border-[hsl(30_65%_50%/0.35)]",
    bg: "bg-[hsl(30_65%_50%/0.12)] dark:bg-[hsl(30_65%_50%/0.08)]",
