      ...
      <ScrollRevealItem>
        ...
        >
           <div className={`flex flex-col ${isEven ? "md:flex-row" : "md:flex-row-reverse"} items-start md:items-center gap-0`}>
            {/* Text */}
              <div className="flex-1 px-4 py-3.5 sm:px-5 sm:py-4 flex flex-col justify-start">
            ...
            <div className="flex-1 relative overflow-hidden bg-card flex items-center justify-center min-h-[200px] md:min-h-0 aspect-[4/3] md:aspect-auto md:self-stretch">
              ...
              <motion.img
                src={s.image}
                alt={s.title}
                className="absolute inset-0 w-full h-full object-contain z-[1] mix-blend-screen scale-[1.35]"
                style={{ opacity: 0.85 }}
                animate={
                  hoveredIndex === i
