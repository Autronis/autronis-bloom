...
const team: TeamMember[] = [
  {
    ...
    skills: [
      { label: "Workflows", icon: Wrench, category: "automation" },
      { label: "Integrations", icon: Cog, category: "automation" },
      { label: "Dashboards", icon: BarChart3, category: "automation" },
      ...
      { label: "API's", icon: Radio, category: "data" },
      { label: "Data enrichment", icon: Database, category: "data" },
      { label: "Processes", icon: Puzzle, category: "operations" },
      { label: "CRM", icon: FolderOpen, category: "operations" },
      { label: "Growth", icon: Zap, category: "operations" },
    ],
  ...
  },
  {
    ...
    skills: [
      ...
      { label: "Dashboards", icon: BarChart3, category: "automation" },
      { label: "AI automation", icon: Bot, category: "ai" },
      { label: "Knowledge bases", icon: BookOpen, category: "ai" },
      { label: "LLM integrations", icon: Brain, category: "ai" },
      { label: "Lead scraping", icon: Search, category: "data" },
      { label: "API's", icon: Radio, category: "data" },
      { label: "Data enrichment", icon: Database, category: "data" },
      { label: "Reporting", icon: FileBarChart, category: "operations" },
      { label: "CRM", icon: FolderOpen, category: "operations" },
      { label: "Processes", icon: Puzzle, category: "operations" },
    ],
