...
const t = {
  en: {
    ...
    pricingPackages: [
      { name: "Starter", price: "€995", sub: "One-time", features: ["One-pager or up to 5 pages", "Custom design — no templates", "Responsive & SEO-optimized", "Contact form + notification", "1 month support after delivery"] },
      { name: "Growth", price: "€1.995", sub: "One-time", popular: true, features: ["Full website + CMS", "2 automations (lead → CRM, chatbot, etc.)", "Analytics & Cal.com integration", "Custom design — no templates", "3 months support"] },
      { name: "Scale", price: "€3.495+", sub: "One-time", features: ["Everything in Growth", "Unlimited automations", "AI features (chatbot, personalization)", "Ongoing maintenance & growth", "Dedicated support"] },
    ],
  ...
  nl: {
    ...
    pricingPackages: [
      { name: "Starter", price: "€995", sub: "Eenmalig", features: ["One-pager of max 5 pagina's", "Custom design — geen templates", "Responsive & SEO-geoptimaliseerd", "Contactformulier + notificatie", "1 maand support na oplevering"] },
      { name: "Groei", price: "€1.995", sub: "Eenmalig", popular: true, features: ["Volledige website + CMS", "2 automatiseringen (lead → CRM, chatbot, etc.)", "Analytics & Cal.com integratie", "Custom design — geen templates", "3 maanden support"] },
      { name: "Scale", price: "€3.495+", sub: "Eenmalig", features: ["Alles van Groei", "Onbeperkte automatiseringen", "AI-features (chatbot, personalisatie)", "Doorlopend onderhoud & groei", "Doorlopende support"] },
    ],
