        ...
        <ScrollReveal className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {stats.map((stat) => (
            <ScrollRevealItem key={stat.label}>
              <div className="rounded-lg border border-border bg-card p-4 sm:p-5 text-center transition-all duration-300 hover:border-primary/30 hover:shadow-[0_0_20px_hsl(174_78%_41%/0.06)]">
